...
import 'package:tradingapp/MarketWatch/Screens/InstrumentDetailScreen/corporate_info_model.dart';
import 'package:tradingapp/MarketWatch/Screens/SearchScreen/searchby_string_model.dart';
...
//  'http://192.168.130.48:9010/v1/get_fii_history_data/'
  ...
  Future<IRCTCData?> fetchIRCTCData(String Symbol) async {
    ...
    if (response.statusCode == 200) {
      final jsonData = json.decode(response.body);
      print(jsonData);
      return IRCTCData.fromJson(jsonData);
    } else {
      throw Exception('Failed to load data');
    }
  }
