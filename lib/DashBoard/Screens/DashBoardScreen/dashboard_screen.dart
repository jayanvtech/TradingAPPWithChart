  ...
  final List<Map<String, dynamic>> mostBought = [
    {
      ...
      'change': '+90.42',
      'image':
          'https://ekyc.arhamshare.com/img//trading_app_logos//YESBANK.svg',
    },
    {
      'name': 'IRFC',
      'price': 158,
    ...
    },
    {
      ...
      'change': '-1.90',
      'image':
          'https://ekyc.arhamshare.com/img//trading_app_logos//TATASTEEL.svg',
    },
    {
      'name': 'IDEA',
      'price': 14.00,
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    if (stocks[index] != "Unknown Index") {
                      final priceChange = stocks[index]['price'] != null
                          ? double.parse(stocks[index]['price']) -
                              double.parse(stocks[index]['close'])
                          : 0;
