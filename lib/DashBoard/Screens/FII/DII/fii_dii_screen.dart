                                                       ...
                                                       children: [
                                                         ...
                                                         height: 10,
                                                           child: LineWidthExample(
                                                                value: fiiDifference,
                                                           lineColor: isNegative ? Colors.red : Colors.green,
                                                              ),
                                                         ),
                                                       ],
                                                     ),
            ...
            _isDailySelected
                      ...
                      builder: (BuildContext context,
                        ...
                        if (snapshot.connectionState ==
                          ...
                          if (snapshot.hasError)
                            ...
                            var data = snapshot.data!.entries.toList();
                            data.sort((a, b) => b.key
                                .compareTo(a.key)); // sort in descending order
                              ...
                              child: ListView.separated(
                                ...
                                itemBuilder: (context, index) {
                                  if (index == 0) {
                                    ...
                                    var diiDifference = data[itemIndex]
                                        .value['dii_buy_sell_difference'];
                                    var diiFnOAmountWise = data[itemIndex]
                                        .value['dii_fnoDii_amount_wise'];
                                    ...
                                    bool isNegative2 = diiDifference
                                        .toString()
                                        .startsWith('-');
                                    bool isNegative3 = diiFnOAmountWise
                                        .toString()
                                        .startsWith('-');
                ...
                : Expanded(
                    child: FutureBuilder<List<FiiData>>(
                      future: isSelected == 0
                          ? ApiService()
                              .fetchStockAndIndexData(type: "fo_stocks")
                          : ApiService()
                              .fetchStockAndIndexData(type: "fo_index"),
                      builder: (BuildContext context,
                          AsyncSnapshot<List<FiiData>> snapshot) {
                        if (snapshot.connectionState ==
                            ConnectionState.waiting) {
                          return Center(child: CircularProgressIndicator());
                        } else if (snapshot.hasError) {
                            ...
                            child: ListView.separated(
                              ...
                              itemBuilder: (context, index) {
                                if (index == 0) {
                                  ...
                                  bool isNegative3 = fiiData
                                      .fiiNetPurchaseSalesFut
                                      .toString()
                                      .startsWith('-');
                      ...
                      builder: (BuildContext context,
                        ...
                        if (snapshot.connectionState ==
                          ...
                          if (snapshot.hasError)
                            ...
                            var data =
                                snapshot.data!.success.data.entries.toList();
                            data.sort((a, b) => b.key
                                .compareTo(a.key)); // sort in descending order
                              ...
                              child: ListView.separated(
                                ...
                                itemBuilder: (context, index) {
                                  if (index == 0) {
                                    ...
                                    var Call = data[itemIndex]
                                        .value
                                        .option
                                        .fii
                                        .call
                                        .netOiChange;
                                    var Put = data[itemIndex]
                                        .value
                                        .option
                                        .fii
                                        .put
                                    ...
                                    bool isNegative1 =
                                        Call.toString().startsWith('-');
                                    bool isNegative2 =
                                        Put.toString().startsWith('-');
