...
class OrderValues {
  ...
  factory OrderValues.fromJson(Map<String, dynamic> json) {
    return OrderValues(
      ...
      orderUniqueIdentifier: json['OrderUniqueIdentifier'],
      algoID: json['AlgoID']?? '',
      algoCategory: json['AlgoCategory']?? 0,
      orderLegStatus: json['OrderLegStatus'],
...
class OrderHistory {
  ...
  final String sellOrderEntryTime;
  final String buyOrderEntryTime;
  ...
  factory OrderHistory.fromJson(Map<String, dynamic> json) {
    return OrderHistory(
      ...
      orderEntryTime: json['OrderEntryTime'].toString(),
      orderType: json['OrderType'].toString(),
      triggerPrice: json['TriggerPrice'].toString(),
      status: json['Status'].toString(),
      tradeId: json['TradeId'].toString(),
      reasonForRejection: json['ReasonforRej'].toString(),
      ...
      modifiedByUser: json['ModifiedByUser'].toString(),
      orderSource: json['OrderSource'].toString(),
      seriesCode: json['SeriesCode'].toString(),
      sellOrderEntryTime: json['SellOrderEntryTime'].toString(),
      buyOrderEntryTime: json['BuyOrderEntryTime'].toString(),
      ...
      sipDate: json['SipDate'].toString(),
      fillTime: json['FillTime'].toString(),
      tradeModDtTime: json['TradeModDtTime'].toString(),
      tradePrice: json['TradePrice'].toString(),
      tradeTime: json['TradeTime'].toString(),
      transType: json['TransType'].toString(),
      transTypeString: json['TransTypeString'].toString(),
      validityString: json['ValidityString'].toString(),
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'SellOrderEntryTime': sellOrderEntryTime,
      'BuyOrderEntryTime': buyOrderEntryTime,
