...
import 'package:flutter/material.dart';
import 'package:tradingapp/Profile/Screens/ProfileScreen/Reports/ledger_more_details.dart';
    ...
    return Scaffold(
      bottomSheet: Container(
        ...
        child: Row(
          ...
          children: [
            Text(
                "Total Balance: ${double.parse(AppVariables.TotalBalance.toString()).toStringAsFixed(2)} DR"),
            ElevatedButton(
              onPressed: () {},
              child: Text('Export'),
                  ...
                  return Padding(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        ...
                        elevation: 0,
                        foregroundColor:
                            selectedCocd == cocd ? Colors.blue : Colors.grey,
                ...
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    final filteredTransactions =
                      ...
                      final isValidAmount =
                          transaction.crAmt != '0' || transaction.drAmt != '0';
                      final matchesCocd = selectedCocd == 'ALL' ||
                          selectedCocd == null ||
                          transaction.cocd == selectedCocd;
                      final hasNarration =
                          selectedCocd != 'ALL' || transaction.narration != "";
                      final hasASSOCIATEOPENINGBALANCE = selectedCocd !=
                              'ALL' ||
                          transaction.narration != "ASSOCIATE OPENING BALANCE";

                      final hasASSOCIATEOPENINGBALANCEBSE_CASH = selectedCocd !=
                              'BSE_CASH' ||
                          transaction.narration != "ASSOCIATE OPENING BALANCE";
                      final hasASSOCIATEOPENINGBALANCENSE_CASH = selectedCocd !=
                              'NSE_CASH' ||
                          transaction.narration != "ASSOCIATE OPENING BALANCE";
                      final hasASSOCIATEOPENINGBALANCECD_NSE = selectedCocd !=
                              'CD_NSE' ||
                          transaction.narration != "ASSOCIATE OPENING BALANCE";
                      final hasASSOCIATEOPENINGBALANCEMF_BSE = selectedCocd !=
                              'MF_BSE' ||
                          transaction.narration != "ASSOCIATE OPENING BALANCE";
                      final hasASSOCIATEOPENINGBALANCENSE_DLY = selectedCocd !=
                              'NSE_DLY' ||
                          transaction.narration != "ASSOCIATE OPENING BALANCE";
                      final hasASSOCIATEOPENINGBALANCENSE_FNO = selectedCocd !=
                              'NSE_FNO' ||
                          transaction.narration != "ASSOCIATE OPENING BALANCE";
                      final hasASSOCIATEOPENINGBALANCENSE_SLBM = selectedCocd !=
                              'NSE_SLBM' ||
                          transaction.narration != "ASSOCIATE OPENING BALANCE";
...
//
                        ...
                        return GestureDetector(
                          onTap: () {
                            Get.to(() =>
                                LedgerMoreDetails(transaction: transaction));
                          },
                          child: Container(
                            margin: EdgeInsets.symmetric(
                                vertical: 0.0, horizontal: 5.0),
