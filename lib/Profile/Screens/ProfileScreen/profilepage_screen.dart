...
import 'package:tradingapp/Profile/Screens/ProfileScreen/Reports/fund_transcation_screen.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(foregroundColor: Colors.black, backgroundColor: Colors.white,elevation: 0,scrolledUnderElevation: 0,
        actions: [
          ElevatedButton(
            onPressed: () async {
              await logout();
                                                  ...
                                                  children: [
                                                    Text(
                                                      "₹ ${double.parse(
                                                        ...
                                                        .toStringAsFixed(2)}", // Replace `cashAvailable` with your actual field
                                                      style: TextStyle(
                                                          fontSize: 20,
                                                          fontWeight:
                                                              FontWeight.bold),
