class Balance {
  ...
  final String pledgeCollateralBenefit;
  ...
  factory Balance.fromJson(Map<String, dynamic> json) {
    ...
    return Balance(
      ...
      collateral: limitObject['RMSSubLimits']['collateral'].toString(),
      ...
      pledgeCollateralBenefit: limitObject['marginAvailable']['PledgeCollateralBenefit'].toString(),
